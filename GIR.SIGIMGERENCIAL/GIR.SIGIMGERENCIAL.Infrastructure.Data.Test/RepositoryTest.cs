...
using GIR.SIGIMGERENCIAL.Domain.Repository;
...
using GIR.SIGIMGERENCIAL.Infrastructure.Data.Repository;
using GIR.SIGIMGERENCIAL.Infrastructure.Data.Repository.Admin;
//using GIR.SIGIMGERENCIAL.Infrastructure.Data.Test.DTO;
using Microsoft.VisualStudio.TestTools.UnitTesting;

namespace GIR.SIGIMGERENCIAL.Infrastructure.Data.Test
{
    [TestClass]
    public class RepositoryTest
    {
        ...
        [TestMethod]
        public void GravaLogAcesso()
        {
            var unitOfWork = new UnitOfWork();
            IRepository<LogAcesso> logAcessoRepository = new Repository<LogAcesso>(unitOfWork);
